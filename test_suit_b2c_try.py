...
class Test_shopping_half_year:
    ...
    def test_math_rus_half_year(self, browser):
        halfyear = Half_year_methods
        halfyear.buy_math_rus_half_year(browser, card_1, mmyy_1, cvv_1, paypass_1)
        congrat = 'https://57211.shot-uchi.ru/students/payments/complete'
        current_url = browser.current_url
        index = current_url.find(congrat)
        assert current_url == congrat, 'not correct page'
    ...
    def test_math_rus_eng_half_year(self, browser):
        halfyear = Half_year_methods
        halfyear.buy_math_rus_eng_half_year(browser, card_1, mmyy_1, cvv_1, paypass_1)
        congrat = 'https://57211.shot-uchi.ru/students/payments/complete'
        current_url = browser.current_url
        index = current_url.find(congrat)
        assert current_url == congrat, 'not correct page'
    ...
    def test_math_rus_eng_prog_half_year(self, browser):
        halfyear = Half_year_methods
        halfyear.buy_math_rus_eng_prog_half_year(browser, card_1, mmyy_1, cvv_1, paypass_1)
        congrat = 'https://57211.shot-uchi.ru/students/payments/complete'
        current_url = browser.current_url
        index = current_url.find(congrat)
        assert current_url == congrat, 'not correct page'
    ...
    def test_math_rus_eng_prog_bio_half_year(self, browser):
        halfyear = Half_year_methods
        halfyear.buy_math_rus_eng_prog_bio_half_year(browser, card_1, mmyy_1, cvv_1, paypass_1)
        congrat = 'https://57211.shot-uchi.ru/students/payments/complete'
        current_url = browser.current_url
        index = current_url.find(congrat)
        assert current_url == congrat, 'not correct page'
    ...
    def test_math_rus_eng_prog_bio_lit_half_year(self, browser):
        halfyear = Half_year_methods
        halfyear.buy_math_rus_eng_prog_bio_lit_half_year(browser, card_1, mmyy_1, cvv_1, paypass_1)
        congrat = 'https://57211.shot-uchi.ru/students/payments/complete'
        current_url = browser.current_url
        index = current_url.find(congrat)
        assert current_url == congrat, 'not correct page'
