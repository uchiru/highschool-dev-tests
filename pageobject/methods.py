...
def new_subjects_year(browser, card_1, mmyy_1, cvv_1, paypass_1, choose_checkbox):
    ...
    full_version = wdw(browser, 40).until(EC.element_to_be_clickable(headpage_elements.full_version_button)).click()
    if choose_checkbox == 'bio':
        modern_biology_click = wdw(browser, 40).until(
            EC.element_to_be_clickable(payments_page_elements.modern_biology_check_box)).click()
    elif choose_checkbox == 'lit':
        literature_click = wdw(browser, 40).until(
    ...
    buy_click = wdw(browser, 40).until(EC.element_to_be_clickable(payments_page_elements.buy_button)).click()
    ...
    mmyy = wdw(browser, 40).until(EC.element_to_be_clickable(card_data_page_elements.card_date)).send_keys(
        card_data.mmyy_1)
    cvv = wdw(browser, 40).until(EC.element_to_be_clickable(card_data_page_elements.cvv_num)).send_keys(
        card_data.cvv_1)
    card_buy_click = wdw(browser, 40).until(
    ...
    paypass = wdw(browser,40).until(EC.element_to_be_clickable(cloud_page_elements.password_input)).send_keys(
        card_data.paypass_1)
    paypass_click = wdw(browser, 40).until(EC.element_to_be_clickable(cloud_page_elements.paypass_button)).click()
