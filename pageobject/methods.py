...
def new_subjects_year(browser, card_1, mmyy_1, cvv_1, paypass_1, choose_checkbox):
    ...
    card = wdw(browser, 40).until(EC.presence_of_element_located(card_data_page_elements.card_num)).send_keys(
        card_data.card_1)
    mmyy = wdw(browser, 40).until(EC.presence_of_element_located(card_data_page_elements.card_date)).send_keys(
        card_data.mmyy_1)
    ...
    paypass = wdw(browser,40).until(EC.presence_of_element_located(cloud_page_elements.password_input)).send_keys(
        paypass_1)
